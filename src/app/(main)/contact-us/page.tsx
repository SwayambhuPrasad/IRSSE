...
const page = () => {
  return (
    <div>
      <div className="container w-full h-full m-auto lg:px-14 p-5   flex flex-col items-center justify-center px-5 bg-white">
          ...
          <Card className="py-4 rounded-sm">
            <CardBody className="overflow-visible py-2 space-y-5">
              ...
              <Textarea
                ...
                labelPlacement="outside"
              ></Textarea>
              <Button className="bg-blue-100 text-blue-500 rounded-sm">
                Submit
              </Button>
            </CardBody>
          </Card>
